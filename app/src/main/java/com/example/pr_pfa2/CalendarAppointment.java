...
public class CalendarAppointment extends AppCompatActivity implements CalendarAdapter.OnItemListener {
    ...
    private void setMonthView() {
        ...
        if (calendarAdapter == null) {
            calendarAdapter = new CalendarAdapter(CalendarAppointment.this, daysInMonth, this, selectedYear, selectedMonth);
        } else {
    ...
    public void onItemClick(int position, String dayText, CalendarAdapter adapter) {
        ...
        if (!dayText.isEmpty()) {
            ...
            String message2 = String.valueOf(selectedMonth);
            date.setText(message);
            datev2.setText(message2);
            Intent shed = new Intent(CalendarAppointment.this, Appointement.class);
            shed.putExtra("date", message);
            shed.putExtra("dateMonth", message2);
            startActivity(shed);
